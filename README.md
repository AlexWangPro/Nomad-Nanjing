# Nomad Nanjing v2.3 — Railway 专用修复版
...
- 手机相册支持一次多选，也可以分批继续添加。
- 最多 8 张，选择后可逐张删除并重新上传。
- 浏览器先转 WebP 并压缩到每张 100KB 内。
- 服务器使用 Sharp 二次校验、转码和压缩，最终文件统一为 `.webp`。
- 提交成功后显示独立的“已提交，待审核”确认界面。
